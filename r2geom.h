...
public:
    ...
    void computeSmoothedContour(R2Contour& smoothedContour) const;
};
...
public:
    ...
    // For (auto) framing contours:
    // area of internal part
    double internalArea() const;
};
